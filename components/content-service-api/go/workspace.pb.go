...
type WorkspaceLogDownloadURLRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceLogDownloadURLRequest) Reset() {
	*x = WorkspaceLogDownloadURLRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceLogDownloadURLRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceLogDownloadURLRequest) ProtoMessage() {}

func (x *WorkspaceLogDownloadURLRequest) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceLogDownloadURLRequest.ProtoReflect.Descriptor instead.
func (*WorkspaceLogDownloadURLRequest) Descriptor() ([]byte, []int) {
	return file_workspace_proto_rawDescGZIP(), []int{2}
}

func (x *WorkspaceLogDownloadURLRequest) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
func (x *WorkspaceLogDownloadURLRequest) GetWorkspaceId() string {
	if x != nil {
		return x.WorkspaceId
	}
	return ""
...
func (x *WorkspaceLogDownloadURLRequest) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
type WorkspaceLogDownloadURLResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceLogDownloadURLResponse) Reset() {
	*x = WorkspaceLogDownloadURLResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceLogDownloadURLResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceLogDownloadURLResponse) ProtoMessage() {}

func (x *WorkspaceLogDownloadURLResponse) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceLogDownloadURLResponse.ProtoReflect.Descriptor instead.
func (*WorkspaceLogDownloadURLResponse) Descriptor() ([]byte, []int) {
	return file_workspace_proto_rawDescGZIP(), []int{3}
}

func (x *WorkspaceLogDownloadURLResponse) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
var file_workspace_proto_rawDesc = []byte{
	...
	0x22, 0x7f, 0x0a, 0x1e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x4c, 0x6f, 0x67,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x12, 0x21, 0x0a,
	...
	0x64, 0x22, 0x33, 0x0a, 0x1f, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x4c, 0x6f,
	0x67, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x83, 0x01, 0x0a, 0x16, 0x44, 0x65, 0x6c, 0x65, 0x74,
	...
	,
...
var file_workspace_proto_goTypes = []interface{}{
	...
	(*WorkspaceLogDownloadURLRequest)(nil),  // 2: contentservice.WorkspaceLogDownloadURLRequest
	(*WorkspaceLogDownloadURLResponse)(nil), // 3: contentservice.WorkspaceLogDownloadURLResponse
	(*DeleteWorkspaceRequest)(nil),          // 4: contentservice.DeleteWorkspaceRequest
	(*DeleteWorkspaceResponse)(nil),         // 5: contentservice.DeleteWorkspaceResponse
}
var file_workspace_proto_depIdxs = []int32{
	...
	2, // 1: contentservice.WorkspaceService.WorkspaceLogDownloadURL:input_type -> contentservice.WorkspaceLogDownloadURLRequest
	4, // 2: contentservice.WorkspaceService.DeleteWorkspace:input_type -> contentservice.DeleteWorkspaceRequest
	1, // 3: contentservice.WorkspaceService.WorkspaceDownloadURL:output_type -> contentservice.WorkspaceDownloadURLResponse
	3, // 4: contentservice.WorkspaceService.WorkspaceLogDownloadURL:output_type -> contentservice.WorkspaceLogDownloadURLResponse
	5, // 5: contentservice.WorkspaceService.DeleteWorkspace:output_type -> contentservice.DeleteWorkspaceResponse
...
func file_workspace_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_workspace_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceLogDownloadURLRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_workspace_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceLogDownloadURLResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
